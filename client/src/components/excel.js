...
function ExcelUploader() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5010/excel/load', formData, {
    ...
    <div className="container mx-auto py-12 flex space-x-8">
      <div className="w-1/3">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Upload Excel Sheet</h2>
      ...
      <div className="w-2/3">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="mt-6 flex items-center">
            ...
            />
            <button 
              className={`ml-4 px-4 py-2 rounded text-white ${loading ? 'bg-gray-500' : 'bg-blue-500 hover:bg-blue-600'}`} 
            ...
            <button 
              className={`ml-4 px-4 py-2 rounded text-white ${isRecording ? 'bg-red-500' : 'bg-green-500 hover:bg-green-600'}`} 
